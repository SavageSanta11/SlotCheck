...
class States {
  ...
  factory States.fromJson(Map<String, dynamic> parsedJson){
    return States(id: parsedJson['state_id'], name: parsedJson['state_name']);
  }
...
class Provinces {
  ...
  factory Provinces.fromJson(Map<String, dynamic> parsedJson) {
    return Provinces(id: parsedJson['district_id'], name: parsedJson['district_name'],  stateId: parsedJson['state_id']);
  }
